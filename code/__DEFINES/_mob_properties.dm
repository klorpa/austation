...
// Taken from goon (https://github.com/goonstation/goonstation/pull/722) with permission.
// Credit to Naksu/vuonojenmustaturska for most of it, with some fixes/improvements by pali
